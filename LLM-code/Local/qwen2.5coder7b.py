...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "qwen2.5coder7b_responses.json")
...
def process_prompts():
    ...
    print(f"\nStarting Qwen2.5-Coder processing of {total_prompts} prompts")
...
if __name__ == "__main__":
    try:
        ...
        if not any(m["name"].startswith("qwen2.5-coder") for m in models.get("models", [])):
            print("Error: Qwen2.5-Coder model not found. Please run:")
